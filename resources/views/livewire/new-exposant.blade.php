<div class="formContactContainer formBecomeContainer">
    ...
    <form aria-label="Formulaire pour devenir exposant" role="form" method="POST"
        ...
        <div class="containerInputLabel containerTagsRepresentation">
            ...
            @if($tagsRepeat)
                <div class="containerInput containerInputBecomeExpo tagsRepresentation containerModulesTagsExpo">
                    @foreach($tagsRepeat as $tagRepeat)
                        <div class="moduleTag moduleTagExpo tagExpoExposant">
                            {{ $tagRepeat }}
                        </div>
                    @endforeach
                </div>
        ...
        <div class="containerTextAreaBecomeExpo">
            <div class="containerInput containerInputTextArea">
                ...
                <textarea required maxlength="256" wire:model="commentString" id="product_description"
            ...
            <span wire:loading.class="containerExposantLoad">{{256 - strlen($commentString)}} caractères max</span>
        </div>
