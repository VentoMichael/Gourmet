...
<head>
    ...
    <title>
        {{ 'Gourmets' }}{{ Request::is('/') ? " | Accueil" : "" }}{{ Request::is('exposants/*') || Request::is('exposants') ? ' | Exposants' : "" }}{{ Request::is('gallery') ? ' | Album photos' : "" }}{{ Request::is('restaurant') ? ' | Restaurant' : "" }}{{ Request::is('about') ? ' | À propos de nous' : "" }}{{ Request::is('contact') ? ' | Contact' : "" }}{{ Request::is('tickets') ? ' | Billets' : "" }}
    </title>
...
<div class="containerBckgImages">
    <img src="{{asset('resources/img/cheese_small.png')}}" alt="Cheese" class="cheese"
         srcset="{{asset('resources/img/cheese.png')}} 1400w, {{asset('resources/img/cheese.png')}} 1600w" sizes="(max-width: 1500px) 300px, 400px">
    <img src="{{asset('resources/img/coldcuts_small.png')}}" srcset="{{asset('resources/img/coldcuts_small.png')}} 1400w, {{asset('resources/img/coldcuts.png')}} 1600w"
         sizes="(max-width: 1500px) 300px, 400px" alt="Coldcuts" class="coldcuts">
    <img src="{{asset('resources/img/wine_small.png')}}" srcset="{{asset('resources/img/wine_small.png')}} 1400w, {{asset('resources/img/wine.png')}} 1600w"
...
<footer>
        ...
        <div class="containerPracticalInformation">
            <section>
                ...
                <div class="textPracticalInformation">
                    <p>
                        Le {{\Carbon\Carbon::parse($praticalInformations->first()->startDate)->format('d/m/Y')}}
                    </p>
                    <p>
                        Et le {{\Carbon\Carbon::parse($praticalInformations->first()->endDate)->format('d/m/Y')}}
                    </p>
                </div>
            </section>
            <section>
    ...
    <a href="{{route('dashboard.index')}}">
        <img class="logoFooter" src="{{ asset('resources/svg/Logo_club.png') }}" alt="Redirection vers la page d'acceuil">
    </a>
    <div role="banner">

        <p class="actualityFooter"><a href="#" class="containerActualityFooter">Suivez notre actualité sur :<img
                    src="{{ asset('resources/svg/facebook.svg') }}"
